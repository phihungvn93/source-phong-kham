...
?>
<?php
	$loaisp = $qt->ListTB($totalRows, $pageNum,$pageSize, $TieuDe);
?>
<style>
...
<form action="" method="get" name="form2" id="form2">
	<input type="hidden" name="p" id="p" value="tb_xem" />
...
<tr>  	<td class="anhien">{id}</td>
		...
		<td class="anhien"><a class="smallButton anhien" id="ma_{id}"  AnHien="bang=pages&ma=idPa&id={id}"  href="#"><img  src="images/ah_{AnHien}.png"></a></td>
      	<td width="100" align="center">
            <a class="smallButton" href="main.php?p=tb_chinh&id={id}"><img  src="images/pencil.png" title="Sửa Tin"></a>
            <a class="smallButton" href="tb_xoa.php?id={id}" onclick="return confirm('Bạn có muốn xóa !!! ');"><img src="images/close.png" title="Xóa Tin"></a>
  		</td>
</tr>
