...
function CheckAuthentication()
{
	...
	return isset($_SESSION['tg_login_id']);
}
...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl.'upload/hinhanh/',
		'directory' => $baseDir . 'hinhanh' ,
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,asf,swf',
		'deniedExtensions' => '');
$config['ResourceType'][] = Array(
		'name' => 'Banner',
